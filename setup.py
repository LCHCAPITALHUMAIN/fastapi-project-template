...
setup(
    ...
    description="Awesome fastapi_project_template created by LCHCAPITALHUMAIN",
    url="https://github.com/LCHCAPITALHUMAIN/fastapi-project-template/",
    long_description=read("README.md"),
    long_description_content_type="text/markdown",
    author="LCHCAPITALHUMAIN",
